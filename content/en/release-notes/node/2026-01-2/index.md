...
This release resolves an issue seen when upgrading appliances using the NCA-1210 and Dell R250 platforms running Ubuntu 22.04 to [version n-2.23.4]({{<relref "../2026-01">}}), which caused the upgrade of a particular OS package to fail due to an artifact left over from the imaging process. Appliances using these platforms can now successfully upgrade to this release.
