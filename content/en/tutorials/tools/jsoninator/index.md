...
2. Run JSONinator in dry-run mode (default):
  ...
  ./jsoninator -plan=my-plan.yaml
  ```
3. Review the generated report files in the specified report path.
...
{{<tgimg src="jsoninator-dryrun-report.png" width="50%" caption="Example JSONinator dry-run report output. Add your screenshot here." >}}

For more details, see the [JSONinator README](https://github.com/trustgrid/jsoninator/blob/main/README.md).
