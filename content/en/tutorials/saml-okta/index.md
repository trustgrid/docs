...
When configuring SAML, enter the Trustgrid Portal URL (e.g., `https://<subdomain>.trustgrid.io/saml`) and select **EmailAddress** for Name ID format and **Email** for Application username.
