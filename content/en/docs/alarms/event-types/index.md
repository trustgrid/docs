...
**Description:** This [event]({{<ref "docs/alarms/events" >}}) will be triggered if a node is configured as a gateway an it lose connectivity to all its configured edge nodes.
...
**Message:** Unexpected error pulling the most recent configuration form the cloud endpoint
