...
Licenses can also be generated programmatically using the `GET /node/license` API endpoint. See [Register a Node via the Trustgrid API]({{<ref "/tutorials/deployments/api-node-registration">}}) for details.
