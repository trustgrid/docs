...
{{<tgimg src="vlan-subinterface.png" alt="VLAN Subinterface Configuration" caption="VLAN Subinterface UI showing physical interface and VLAN options" width="50%" class="float-start">}}
